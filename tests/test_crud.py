"""Test filesystem CRUD operations."""
...
class TestInit:
    ...
    def test_valid_workspace(self, workspace: Path):
    ...
    def test_allow_system_install_flag(self, workspace: Path):
