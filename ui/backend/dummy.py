...
T1_MESSAGES = [
    ...
    _msg("call_abc123", "tool_result", "tool_result",
         "File written: quantum_intro.md (420 bytes)",
         thread_id="t-1", name="write_file"),
    _msg("call_abc124", "tool_result", "tool_result",
         "File written: examples/basic_qubit.py (215 bytes)",
         thread_id="t-1", name="write_file"),
    _msg("call_abc125", "tool_result", "tool_result",
         "Todos updated. 4 item(s) in list.",
         thread_id="t-1", name="update_todos"),
    ...
    _msg("call_def455", "tool_result", "tool_result",
         "# Introduction to Quantum Computing\n\nQuantum computing represents...",
         thread_id="t-1", name="read_file"),
    _msg("call_def456", "tool_result", "tool_result",
         "File written: examples/entanglement.py (340 bytes)",
         thread_id="t-1", name="write_file"),
    _msg("call_def457", "tool_result", "tool_result",
         "Entangled circuit:\n"
         "     ┌───┐     ┌─┐   \n"
         "q_0: ┤ H ├──■──┤M├───\n"
         "     └───┘┌─┴─┐└╥┘┌─┐\n"
         "q_1: ─────┤ X ├─╫─┤M├\n"
         "          └───┘ ║ └╥┘\n",
         thread_id="t-1", name="bash"),
    _msg("call_def458", "tool_result", "tool_result",
         "File edited: quantum_intro.md", thread_id="t-1", name="edit_file"),
    _msg("call_def459", "tool_result", "tool_result",
         "Fetched 4KB of markdown from example.com/quantum-refs",
         thread_id="t-1", name="fetch_url"),
...
T2_MESSAGES = [
    ...
    _msg("ai-1", "ai", "reasoning",
         ...
         thread_id="t-2", name="debugger"),
    _msg("ai-1", "ai", "text", "Let me take a look at parse.py.",
         thread_id="t-2", name="debugger"),
    _msg("ai-1", "ai", "tool_call", {
        "id": "call_dbg1", "name": "read_file", "type": "tool_call",
        "args": {"path": "parse.py"},
    }, thread_id="t-2", name="debugger"),

    _msg("call_dbg1", "tool_result", "tool_result",
         "def parse(row):\n"
         "    return {\n"
         "        'id': row['id'],\n"
         "        'name': row['full_name'],\n"
         "    }\n",
         thread_id="t-2", name="read_file"),

    _msg("ai-2", "ai", "text",
         "Found it — the row uses `name`, not `full_name`. I'll fix the key and run the tests.",
         thread_id="t-2", name="debugger"),
    _msg("ai-2", "ai", "tool_call", {
        "id": "call_dbg2", "name": "edit_file", "type": "tool_call",
        "args": {
            "path": "parse.py",
    ...
    _msg("ai-2", "ai", "tool_call", {
        "id": "call_dbg3", "name": "bash", "type": "tool_call",
        "args": {"command": "python -m pytest tests/test_parse.py -v"},
    }, thread_id="t-2", name="debugger"),

    _msg("call_dbg2", "tool_result", "tool_result",
         "File edited: parse.py", thread_id="t-2", name="edit_file"),
    _msg("call_dbg3", "tool_result", "tool_result",
         "===== test session starts =====\n"
         "tests/test_parse.py::test_basic PASSED\n"
         "tests/test_parse.py::test_empty PASSED\n\n"
         "===== 2 passed in 0.12s =====\n",
         thread_id="t-2", name="bash"),
